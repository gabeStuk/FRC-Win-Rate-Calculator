# Usage:
 ...
 - You can also run this program from the actions tab by triggering the [Run Script](https://github.com/gabeStuk/FRC-Win-Rate-Calculator/actions/workflows/run.yml) action:
